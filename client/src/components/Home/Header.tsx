  ...
  return (
    <header className="text-white">
      ...
      <div className="w-full bg-primary">
        <div className="max-w-7xl mx-auto px-4 md:px-[42px] lg:px-[80px] text-center py-2 text-xs sm:text-sm lg:text-base font-medium flex justify-between items-center">
          <span className="truncate">Welcome to Mprimo online store...</span>
